...
METADATA_AMD64=$(curl -sSL --retry 3 "https://shogo82148-docker-lambda.s3.amazonaws.com/fs/x86_64/base.al2023.json")
ARCHIVE_URL_AMD64=$(echo "$METADATA_AMD64" | jq -r .url)

METADATA_ARM64=$(curl -sSL --retry 3 "https://shogo82148-docker-lambda.s3.amazonaws.com/fs/arm64/base.al2023.json")
